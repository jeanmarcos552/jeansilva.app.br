...
export function Contact() {
  return (
    ...
    >
      ...
      <h2
        style={{ fontSize: "1.75rem", fontWeight: 700, marginBottom: "1rem", letterSpacing: "-0.02em" }}
      >
        Vamos conversar?
      </h2>

      <p style={{ fontSize: "1rem", lineHeight: 1.8, color: "var(--muted)", maxWidth: "480px", marginBottom: "2.5rem" }}>
        Estou aberto a oportunidades remotas, híbridas ou presenciais em Goiânia/GO. CLT ou PJ, disponibilidade
        imediata.
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        ...
        <a href={personal.linkedin} target="_blank" rel="noopener noreferrer" className="contact-link">
          ...
          linkedin.com/in/jean-marcos-full-stack
        </a>
      </div>
    </section>
  )
